...
2. Páginas Amorrortu.
3. Relevamiento de Libro 1 / Libro 2.
...
| Fragmento | Libro 1 | Libro 2 | Fuente recomendada | Relación |
|---|---|---|---|---|
| 113–122 | sí | parcial: 121–122 | Libro 1 | contiene 121–122 |
| 121–122 | contenido en 113–122 | sí | Libro 2 / 1 | incluido por 113–122 |
| 128, 132–134 | no relevado | sí | Libro 2 | independiente |
...
- NO auto-marcar entre sí porque faltan páginas:
  - Libro 2 no cubre 185–186 ni 199.
  - Libro 1 no coincide exactamente con selección teórica del Libro 2.
